...
?>
			...
			<form class='form-horizontal lg-2' action="addvehiclemaintanence.php" method="post" >
                <br>
            ...
            <?php
				...
				if(mysqli_num_rows($records)>0){
					while($row = mysqli_fetch_assoc($records))
					{
						...
						echo "<td><input value=\"Add\" name=\"".$row['CarID']."\" type=\"submit\" style=\"padding: 10px 50px\"</td>";
						echo "</tr>";
					}
				}
			?>
