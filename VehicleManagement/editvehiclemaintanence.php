...
?>				
			...
			<section class="quote-area pt-100">
			   ...
			   <div class="col-md-15 login-left wow fadeInLeft" data-wow-delay="0.4s">
			  	 <div class='row'>
                <div class='col-sm-20'> 
                    <h3><strong>Edit Vehicles Maintanence</strong></h3>
                </div>
            </div>
            <br>
            ...
            <?php
				...
				$sql ="SELECT vehiclelist.Brand,vehiclelist.Model,vehiclelist.PlateNumber,vehiclelist.CarID,maintanencerecord.Date,
