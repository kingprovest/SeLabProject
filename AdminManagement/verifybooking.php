            ...
            <?php
				...
				if(mysqli_num_rows($records)>0){
					...
					{						
							  ...
							  echo "<button class=\"btn btn-success btn-xs \" name=\"".$row['BookingID']."\" value=\"AssignRunner\" href =\"editbookingassignment.php\" data-toggle=\"modal\" data-target=\"#delete\" >Verify Avaibility</button>";
							  echo "</p>";
						      echo "</td>";
							  echo "<tr>";						
