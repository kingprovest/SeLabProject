...
<!-- Start quote Area -->
	<section class="quote-area pt-100">
		...
		<br><br>
		<p class="text-center"><button type="submit" name="backBtn" class='btn btn-default btn-primary' style="background:linear-gradient(to bottom, #6493c4 0%,#375a7f 100%); border: #6493c4" onclick="document.location.href='viewYearlyModelStatistics.php';">Back</button></p>
	</section>
