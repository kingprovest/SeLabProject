			...
			<div class="container">
				<div class="account_grid">
					<div class="col-md-20 login-left wow fadeInLeft" data-wow-delay="0.4s">
						<div class='row'>
							<div class='col-sm-20'> 
								<h3><strong>View Most Popular Car Brand by Year</strong></h3>
								<br>
								<form method="post" action="generateYearlyBrandStatistics.php">
									...
									<button type="submit" name="viewYearlyBrandStatisticsBtn" class='btn btn-default btn-primary' style="background:linear-gradient(to bottom, #6493c4 0%,#375a7f 100%); border: #6493c4">View Statistics</button>
								</form>
								<br>
