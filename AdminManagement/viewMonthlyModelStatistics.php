						...
						<div class='row'>
							<div class='col-sm-20'> 
								...
								<form method="post" action="generateMonthlyModelStatistics.php">
									...
									<button type="submit" name="viewMonthlyModelStatisticsBtn" class='btn btn-default btn-primary' style="background:linear-gradient(to bottom, #6493c4 0%,#375a7f 100%); border: #6493c4; margin: -10px 0 0 200px; padding: 20px; width: 270px">View Statistics</button>
								</form>
								<br>
								<button type="submit" name="backBtn" class='btn btn-default btn-primary' style="background:linear-gradient(to bottom, #6493c4 0%,#375a7f 100%); border: #6493c4; margin: 20px 0 0 700px; padding: 20px; width: 200px" onclick="document.location.href='viewModelStatistics.php';">Back</button>
							</div>
						</div>
					</div>
				</div>
