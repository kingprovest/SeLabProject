<?php
	...
	if(isset($_POST['viewMonthlyBrandStatisticsBtn']))
	{
		$year = $_POST['year'];
		$month = $_POST['month'];
...
?>
	<script type="text/javascript">
		function notifyInvalidPeriod() 
		{
			...
			window.location.href = "viewMonthlyBrandStatistics.php";
		}
	</script>
	...
	<script type="text/javascript">
		window.onload = function () {
			...
			theme: "light2",
			title:{
				text: "Most Popular Car Brand in <?php 
				if($month == 1)
					echo "January ";
				if($month == 2)
					echo "February ";
...
<!-- Start quote Area -->
	<section class="quote-area pt-100">
		...
		<br><br>
		<p class="text-center"><button type="submit" name="backBtn" class='btn btn-default btn-primary' style="background:linear-gradient(to bottom, #6493c4 0%,#375a7f 100%); border: #6493c4; padding: 20px; width: 200px" onclick="document.location.href='viewMonthlyBrandStatistics.php';">Back</button></p>
	</section>
